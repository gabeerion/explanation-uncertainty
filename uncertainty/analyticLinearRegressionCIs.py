...
def analyticLinearTest_GLRT_singleCoef(fittedModel, X, y):
    """
    Computes a test statistic determining whether each coefficient in the fitted model is significantly different from
    ...
    :param y: The observations on which we fit the model
    :param alpha:
    :return: a vector of p-values of length d, indicating whether we can reject the hypothesis that the coefficient is zero
    """
